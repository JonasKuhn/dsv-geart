                        ...
                        <div class="row">
                            ...
                            <section class="col-lg-7 connectedSortable">
                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <ul class="nav nav-tabs pull-right">
                                        <li class="pull-left header"><i class="fa ion-speedometer"></i> Consumo Atual</li>
                                    </ul>
                                    <div class="tab-content no-padding">
                                        <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 260px; width: 900px;">
                                            <?php
                                               // include './dados_atual.php';x
                                            ?>
                                        </div>
                            ...
                            <section class="col-lg-5 connectedSortable"> 
                                ...
                                <div class="nav-tabs-custom"> 
                                    <!-- Tabs within a box --> 
                                    <ul class="nav nav-tabs pull-right"> 
                                        <li class="pull-left header"><i class="fa ion-android-calendar"></i> Calendário</li> 
                                    </ul> 
                                    <div class="tab-content no-padding"> 
                                        <!-- Morris chart - Sales --> 
                                        <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 260px;"></div> 
                                    </div> 
                                </div> 
                                <!-- /.nav-tabs-custom --> 
                            </section> 
